...
import dormitoryMS.domain.user.student.graduate.Graduate;
import dormitoryMS.domain.user.student.undergraduate.Undergraduate;
...
public class StudentRepository {
    ...
    public void save(Student student) {
        String sql = "INSERT INTO students (student_id, name, gpa, school, distance_to_school, student_type) VALUES (?, ?, ?, ?, ?, ?)";
